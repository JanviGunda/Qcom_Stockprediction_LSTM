...
def main():
	st.title("Qualcomm Stock Price Prediction")
	html_temp = """
	 
	<div style="background-color:rgb(98, 186, 16);padding:10px">
	<h2 style="color:black;text-shadow: 0 4px 10px rgba(0, 0, 0, 0.603);text-align:center;">Qualcomm Predicted CLosed Price</h2>
	</div>
	"""
